...
export const ar: Dict = {
  ...
  docs: {
    ...
    beats: [
      ...
      "*اضغط «وصول فاتورة المورّد»* (باللون البنفسجي — محاكاة). تطالب الفاتورة بـ 10. يُرفع اقتراحان وتُنقل إلى شاشة المراجعة. ضغطة واحدة، دون مطالبة ثانية.",
    ...
    rows: {
      ...
      events: {
        c: "مُطلِق الأحداث",
        s: "محاكاة موسومة",
        l: "زرّان يُدخلان الفاتورة وإشعار الدائن. موسومان باللون البنفسجي وبكلمة «محاكاة» أينما ظهرا.",
      },
      scans: {
