...
export const ar: Dict = {
  ...
  docs: {
    ...
    features: {
      ...
      languages: {
        name: "الإنجليزية والعربية، بما في ذلك المحرّك",
        body: "مبدّل اللغة في الشريط العلوي يغيّر كل الشاشات — بما فيها هذا الملخّص — وتعود الصفحة من اليمين إلى اليسار بخطّ عربي. وجمل محرّك التسوية نفسها مترجَمة أيضًا: يخزّن الاقتراح الوقائع إلى جانب نصّه الإنجليزي، فيُقرأ الفرق المرفوع بإحدى اللغتين قراءةً صحيحة باللغة الأخرى. أمّا معرّفات السجلات والكميات والملاحظات المكتوبة فلا تُترجم أبدًا.",
      },
      settings: {
