 ...
 * convention is left alone - violet means simulated, and these are real records
    ...
    <main className="mx-auto max-w-5xl px-4 py-8 sm:px-6">
      <header className="mb-6">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <span className="rounded-full border border-dashed border-faint px-2 py-0.5 text-[11px] font-semibold uppercase tracking-wide text-muted">
            {t.settings.tag}
          </span>
        </div>
      ...
      <section className="mb-8 space-y-3 rounded-xl border border-dashed border-line bg-background p-5">
